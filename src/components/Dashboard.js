...
export default function Dashboard() {
    ...
    const generatingJonTitle = isGenerating || jobTitle;
    const isGeneratingState = generatingJonTitle === "" ? "cursor-not-allowed opacity-50" : ""
                ...
                <div className="h-full">
                    <div className="flex flex-col h-full">
                        ...
                        <textarea
                            ...
                            className="flex-1 block h-full w-full rounded-md bg-white border border-gray-400 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2 placeholder-gray-500 my-2 text-gray-900"
                        />
                        <button
                            onClick={handleCopy}
